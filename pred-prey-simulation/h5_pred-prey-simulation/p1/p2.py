'''Predator-Prey-Human Simulation'''
    ...
    def eat(self):
        ...
        if not self.moved:
            ...
            if location:
                ...
                self.island.remove(self.island.animal(
...
class Human(Predator):
    ...
    def __init__(self, island, x=0, y=0, s="S"):
...
def main(predator_breed_time=6, predator_starve_time=3, initial_predators=10,
         ...
         human_breedtime=9, human_starve_time=5, hunt_time=5, init_humans=15):
    '''Init values create lists make islant event loop graphing'''
